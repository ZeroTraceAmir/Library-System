...
{
    public class JsonRepository<T> : IRepository<T> where T : IEntity // faghat method haye IRepo ro dare va faghat roye model hayi kar mikone ke Ientity bashan. yani id dashte bashan.
{
